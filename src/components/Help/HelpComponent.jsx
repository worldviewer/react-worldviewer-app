						...
						<Col>
							...
							<div style={{margin: '25px'}}>
								...
								<div style={{backgroundColor: '#50C6C3', color: '#022B36', padding: '25px'}}>
									...
									Today’s belief in ineluctable certainty is the true innovation-killer of our age. In this environment, the best an audacious manager can do is to develop small improvements to existing systems -- climbing the hill, as it were, toward a local maximum, trimming fat, eking out the occasional tiny innovation -- like city planners painting bicycle lanes on the streets as a gesture toward solving our energy problems. Any strategy that involves crossing a valley -- accepting short-term losses to reach a higher hill in the distance -- will soon be brought to a halt by the demands of a system that celebrates short-term gains and tolerates stagnation, but condemns anything else as failure. In short, a world where big stuff can never get done."</i></p>
								</div>
								...
								<p>My current mode of operation is: <i>build everything yourself</i>. I've had to do it that way because even if I feel I understand a way forward, there's just not a lot of consensus to be had for how to move modern science back into an innovative posture. But, this m.o. is a glacially slow process. If I was not making my own graphics, I could instead use that time to brainstorm and build out new site features. I especially need artists who would be willing, once per week, to dedicate some of their personal time towards the creation of new controversy card graphics. In other words, deep Photoshop and Illustrator experience.</p>

								<h3>Maverick Science<br />Thought Leaders</h3><br />

								<p>These are theorists whose work is rejected by mainstream science standards -- either because it challenges a very popular idea, or because it involves the questioning of certain popular assumptions or hypotheses. I need you to try to distill your idea into the controversy card format. Inspect the 182 existing cards, and try to observe the pattern: The point is to get a person to comprehension as quickly as possible, and to place your most compelling evidence up-front. Your text should address a layperson audience, but provide links to more technical details where important.</p>

								<h3>Public Speakers</h3><br />

								<p>I've done talks at conferences, but speaking is not -- yet -- one of my best assets. Do you have a skill for speaking -- either publicly or in online videos? Do you have a studio where you can record high-quality videos? (I may be able to help.) Each of the controversy cards could (and probably should) be turned into a video.</p>

								<h3>Full-Stack Web /<br />Node.js Developers</h3><br />

								<p>What is your story? What has led you from web development to an interest in scientific controversies? Can you point me to former work? Are you fluent in React, Redux, Node and/or AWS?</p>

								<h3>Technical Writers</h3><br />

								<p>If this is your interest, then please read all of the controversy cards and get back to me. My library of controversial science is always quite a bit larger than my ability to read it, and my list of scientific controversies is at all times growing.</p>
