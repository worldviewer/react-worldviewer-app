					...
					<Row>
						<Col>
							...
							<div style={{margin: '15px'}}>
								...
								I'm less interested in your CV than in your grasp for the context of your current or former domain: Do you have a feel for what types of papers get through peer review? Are you aware of problems with the accepted theory? Have you witnessed a defensive posture amongst those who dominate the domain? Have you become disillusioned with academic science? This is your chance to put it back onto a productive track.<br /><br />

								<h3>Online Science Agitators</h3><br />

								This is not to be confused for people who troll others in order to elicit an emotional response. The point of online agitation is to repeatedly "poke the system" to learn how it responds. I am seeking out agitators (informed laypeople are fine) who have an established track record at getting experts to go on the record with responses on the various forums. We will use Controversies of Science as the center of this new network, and I will over time be building out site features to suit your needs to agitate and report back with clear snapshots what you've learned.<br /><br />

								<h3>Artists and Graphic Designers</h3><br />

								My current mode of operation is: build everything yourself. I've had to do it that way because even if I feel I understand a way forward, there's just not a lot of consensus to be had for how to move modern science back into a posture that facilitates innovation. But, this m.o. is a glacially slow process. If I was not making my own graphics, I could instead use that time to brainstorm and build out new site features. I especially need artists who would be willing, once per week, to dedicate some of their personal time towards the creation of new controversy card graphics. In other words, deep Photoshop and Illustrator experience.<br /><br />

								<h3>Maverick Science<br />Thought Leaders</h3><br />

								These are theorists whose work is rejected by mainstream science standards -- either because it challenges a very popular idea, or because it involves the questioning of certain popular assumptions or hypotheses. I need you to try to distill your idea into the controversy card format. Inspect the 182 existing controversy cards, and try to observe the pattern: The point is to get a person to comprehension as quickly as possible, and to place your most compelling evidence up-front. Your text should address a layperson audience, but provide links to more technical details where important.<br /><br />

								<h3>Public Speakers</h3><br />

								I've done talks at conferences. Speaking is not -- yet -- one of my best assets. Do you have a skill for speaking -- either publicly or in online videos? Do you have a studio where you can record high-quality videos? (I may be able to help.) Each of the controversy cards could (and probably should) be turned into a video.<br /><br />
