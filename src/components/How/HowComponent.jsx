					...
					<Row>
						<Col>
							<div className='QuotedText' style={{cursor: 'pointer'}}
								onClick={() => window.open('/science-as-a-golum/worldview/card', '_blank')}>
							...
							<p>This is a problem on so many levels -- for our culture, for our future and especially for <a href='https://www.thunderbolts.info/wp/2017/10/03/science-as-a-personal-journey/' target='_blank' rel='noopener noreferrer'>your own personal development</a>.</p>

							<ul className='BulletedPoints'>
								<li>With such an approach, <a href='https://www.controversiesofscience.com/bandwagon-research/worldview/card' target='_blank' rel='noopener noreferrer'>those few who develop the courage to point out serious fundamental flaws</a> in either theory or process are more likely to be attacked, <a href='https://www.controversiesofscience.com/schmidt/worldview/card' target='_blank' rel='noopener noreferrer'>and their warnings are more likely to go ignored.</a></li>

								<li>The leave-it-to-the-experts approach leaves the impression with the public that progress on big scientific questions will occur regardless of our own personal actions as laypeople. Those who grew up in the 50's, e.g., imagined as kids that great innovations were just going to happen -- <a href='https://www.controversiesofscience.com/innovation-starvation/worldview/card' target='_blank' rel='noopener noreferrer'>and what has happened instead towards the end of their lives is that many have wondered why there are no flying cars.</a></li>

								<li>The concept of <a href='https://www.controversiesofscience.com/expertise/worldview/card' target='_blank' rel='noopener noreferrer'>faith in expertise</a> rests upon the idea that scientists are not prone to layperson problems. But, when we confine deep thought in the sciences to <a href='https://www.controversiesofscience.com/over-specialization/worldview/card' target='_blank' rel='noopener noreferrer'>micro-specialists who themselves are (much like yourself) taking for granted claims in domains outside of their limited expertise</a>, we've culturally accepted the premise that <a href='https://www.controversiesofscience.com/generalist/worldview/card' target='_blank' rel='noopener noreferrer'>generalists are unnecessary.</a></li>

								<li>Worse yet, when people create a void of understanding for themselves on some sort of topic, the mind does not acknowledge this as empty space. <a href='https://www.controversiesofscience.com/believable-narrative/worldview/card' target='_blank' rel='noopener noreferrer'>It replaces that void with imagined, believable narratives.</a> These narratives tend to dominate online conversations.</li>
							</ul>

							<p>We need to culturally come to grips with the historical fact that <a href='https://www.controversiesofscience.com/radio-waves/worldview/card' target='_blank' rel='noopener noreferrer'>experts</a> <a href='https://www.controversiesofscience.com/laser/worldview/card' target='_blank' rel='noopener noreferrer'>are</a> <a href='https://www.controversiesofscience.com/expertise-trust/worldview/card' target='_blank' rel='noopener noreferrer'>sometimes</a> <a href='https://www.controversiesofscience.com/epigenetics/worldview/card' target='_blank' rel='noopener noreferrer'>wrong</a> -- and that the stakes are far too big to look to stereotypes for how we <b>imagine</b> that science works. As laypeople, we must take responsibility for our own future by developing our own critical sense for expertise. There is no getting around it: the only way to manifest our imagined future is to directly witness for ourselves the true complexity of the scientific enterprise.</p>
